...
def sanitize_def(map_def):
    ...
    test_err(0 < len(map_def["tiles"]), "Incorrect number of tiles")
...
def make_tileset_id(map_def,tileset):
    #for tileset in range(len(map_def["tiles"]) // 64):
    print("Bake tileset", tileset)
    tile_array = [prepare_tile(i) for i in
        map_def["tiles"][tileset*64:(tileset+1)*64]]
...
def convert_tileset(map_name):
    ...
    #make_tileset_id(map_def,1)
    #make_tileset_id(map_def,3)
    #make_tileset_id(map_def,4)
    #make_tileset_id(map_def,5)
    #make_tileset_id(map_def,6)
    #make_tileset_id(map_def,7)
